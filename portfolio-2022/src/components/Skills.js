      ...
      <div id="cards">
        <div class="card">
          <div class="container">
            ...
            <p>JavaScript <img src={js} alt="js" /></p>
          </div>
        </div>
        <div class="card">
          <div class="container">
            ...
            <p>React.js <img src={react} alt="react" /></p>
            <p>Node.js <img src={node} alt="node" /></p>
            <p>TailwindCSS <img src={tailwind} alt="tailwind" /></p>
            <p>Laravel <img src={laravel} alt="laravel" /></p>
          </div>
        </div>
        <div class="card">
          <div class="container">
            ...
            <p>MySQL <img src={mysql} alt="mysql" /></p>
            <p>MongoDB <img src={mongodb} alt="mongodb" /></p>
            <p>Git <img src={git} alt="git" /></p>
            <p>Github <img src={github} alt="github" /></p>
          </div>
        </div>
      </div>
    </div>
